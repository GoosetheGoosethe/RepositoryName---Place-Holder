...
#function run when game is started
 ...
 #giving players items
     ...
     execute if entity @s[scores={weaponry=1}] run give @s stone_sword[item_name=["§5 Stone Sword"]]
     execute if entity @s[scores={weaponry=2}] run give @s golden_axe[item_name=["§5 Golden Axe"]]
     execute if entity @s[scores={weaponry=3}] run give @s bow[item_name=["§5 Bow"]]
     execute if entity @s[scores={weaponry=3}] run give @s arrow 16

     execute if entity @s[scores={munition=1}] run give @s fire_charge[consumable={consume_seconds:1000000000},item_name=["§4 Fire Ball"]] 12
     execute if entity @s[scores={munition=2}] run give @s tnt[consumable={consume_seconds:1000000000},item_name=["§4 TNT"]] 10
     execute if entity @s[scores={munition=3}] run give @s lightning_rod[consumable={consume_seconds:1000000000},item_name=["§4 Lightning Rod"]] 6
